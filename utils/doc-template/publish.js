...
function buildNav(members) {
    //var nav = '<h2 class="home-title"><a href="index.html">Home</a></h2>',
    var nav = '<a href="index.html"><div id="home-button">⌂</div></a>',
        seen = {};
    ...
    if (members.classes.length) {
        ...
        members.classes.forEach(function(c) {
            ...
            if (moduleClasses !== -1 && moduleClasses < members.classes.length) {
                nav += '<h3>API Reference</h3><ul>';
                moduleClasses = -1;
            }
            if ( !hasOwnProp.call(seen, c.longname) ) {
                
                if (c.name === 'mraid' || c.name === 'Eclair') {
                    subNamespace = false;    
                } else {
                    subNamespace = true;
                }
                
                cssClass = subNamespace ? ' class="sub-namespace"' : '';
                var tiret = subNamespace ? '- ' : '';
                
                nav += '<li' + cssClass + '>'+tiret+linkto(c.longname, c.name)+'</li>';
                
                if (c.name === 'mraid') {
                    
                    mraidAPI.forEach(function (method) {
                       
                       var italicClass = method.indexOf('*') != -1 ? ' custom-api-method' : '';
                       nav += '<li class="sub-namespace'+italicClass+'"><a href="mraid.html#'+ method.split('*')[0] +'">- '+ method +'</a></li>';
...
exports.publish = function(taffyData, opts, tutorials) {
    ...
    */
    ...
    generate('Eclair API Reference', [{kind:'mainpage'}], indexUrl);
